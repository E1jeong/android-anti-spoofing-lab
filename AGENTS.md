...
| **Device & Sysfs** (`device/`) | PI6008K IR AE Full/Center, IR LED/LCD sysfs, lighting detector, daemon watchdog | `IrCameraExposureController`, `HardwareControls`, `DualLightingDetector`, `UbimDaemonClient` | `features/camera-and-calibration`, `technical/build-deployment-requirements` |
